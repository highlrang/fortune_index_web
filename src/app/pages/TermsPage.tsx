      ...
      <div className="relative mx-auto max-w-md px-5 pt-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm fi-text-muted">Voda 서비스 이용에 대한 기본 안내</p>
          </div>
        </div>
        ...
        >
          <section className="fi-glass overflow-hidden rounded-3xl p-5">
            ...
            <p className="text-sm leading-7 fi-text-muted">
              Voda는 타로, 사주, AI 해석을 결합해 자산 운용 멘탈 케어와 재물 흐름 해석 콘텐츠를 제공하는 서비스입니다.
              본 서비스의 모든 정보는 참고용이며, 특정 금융상품의 접근, 정리 또는 유지를 권유하는 금융 자문으로 간주되지 않습니다.
            </p>
          </section>
          ...
          <section className="fi-glass overflow-hidden rounded-3xl p-5">
            ...
            <div className="space-y-3 text-sm leading-7 fi-text-muted">
              <p>이용자는 서비스 내 운세와 흐름 해석을 자신의 성향을 점검하는 참고 자료로만 활용해야 합니다.</p>
              <p>시장 상황, 기업 공시, 환율, 금리, 유동성 등 실제 자산 운용 결과에 영향을 주는 요인은 매우 다양하며 서비스가 이를 모두 반영하지 못할 수 있습니다.</p>
          ...
          <section className="fi-accent-card overflow-hidden rounded-3xl p-5">
            <div className="mb-3 flex items-center gap-2 fi-text-accent">
              ...
              <h2 className="text-base font-semibold fi-text-main">자산 운용 책임 고지</h2>
            </div>
            <p className="text-sm leading-7 fi-text-soft">
              자산군 전반에 관한 모든 판단과 그로 인한 결과는 전적으로 이용자 본인의 책임입니다.
              Voda는 서비스에서 제공한 정보, 해석 또는 알림을 근거로 이루어진 자산 운용 판단에 대해 책임지지 않습니다.
            </p>
          </section>
          ...
          <section className="fi-glass overflow-hidden rounded-3xl p-5">
            ...
            <div className="space-y-3 text-sm leading-7 fi-text-muted">
              ...
              <p>이용자는 관련 법령과 거래소, 증권사, 금융기관의 규정을 별도로 확인해야 하며, 자산 운용 전 필요한 검토를 직접 수행해야 합니다.</p>
            </div>
          </section>
        </motion.div>
      </div>
