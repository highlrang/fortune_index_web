    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-indigo-900 to-violet-950 pb-10">
      ...
      <div className="relative mx-auto max-w-md px-5 pt-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-white">이용약관</h1>
            <p className="text-sm text-white/50">Stock Oracle 서비스 이용에 대한 기본 안내</p>
          </div>
        </div>
        ...
        >
          <section className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl">
            <div className="mb-3 flex items-center gap-2 text-amber-300">
              ...
              <h2 className="text-base font-semibold text-white">서비스 목적</h2>
            </div>
          ...
          <section className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl">
            <h2 className="mb-3 text-base font-semibold text-white">이용자 유의사항</h2>
          ...
          <section className="overflow-hidden rounded-3xl border border-amber-400/30 bg-gradient-to-br from-amber-500/15 to-red-500/10 p-5 backdrop-blur-xl">
            <div className="mb-3 flex items-center gap-2 text-amber-200">
              <ShieldAlert className="h-5 w-5" />
              <h2 className="text-base font-semibold text-white">투자 책임 고지</h2>
            </div>
          ...
          <section className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl">
            <h2 className="mb-3 text-base font-semibold text-white">책임의 제한</h2>
            <div className="space-y-3 text-sm leading-7 text-white/75">
